...
## ----------------------------------------------------------------------------
## --- INSTALLING SUITECLOUD (Nodejs CLI) -------------------------------------
## ----------------------------------------------------------------------------

RUN npm install -g @oracle/suitecloud-cli --unsafe-perm;

## ----------------------------------------------------------------------------
## --- INSTALLING SDFCLI (Java CLI) -------------------------------------------
## ----------------------------------------------------------------------------

ENV PATH /usr/local/lib/sdfcli:$PATH
RUN curl -fsSLO --compressed "https://system.netsuite.com/download/suitecloud-sdk/cli/java/latest/sdf-cli.tar.gz"; \
  mkdir -p /usr/local/lib/sdfcli/; \
  tar -xvf sdf-cli.tar.gz -C /usr/local/lib/sdfcli/; \
  chmod +x /usr/local/lib/sdfcli/sdfcli; \
  rm sdf-cli.tar.gz;