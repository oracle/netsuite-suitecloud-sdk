...
- [netsuite-suitescript-upgrade](./netsuite-suitescript-upgrade): SuiteScript 1.0 to 2.1 migration assistant: analyzes, converts, explains, and validates script upgrades. Covers 125+ API mappings, 34 object conversions, 13 unmapped API workarounds, all script type entry point changes, and 16 categories of breaking behavioral changes. Essential for modernizing legacy SuiteScript codebases.
