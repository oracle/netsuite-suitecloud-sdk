...
This plug-in, compatible with ChatGPT and Codex, bundles the `netsuite-finance-analyst` skill and requires the NetSuite AI Connector Service to access NetSuite data.
