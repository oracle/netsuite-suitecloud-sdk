...
This plug-in, compatible with ChatGPT and Codex, bundles the `netsuite-finance-analyst` skill and requires the NetSuite AI Connector Service to access NetSuite data. The skill supports NetSuite financial analysis and finance operations, including financial reporting, period-close activities, variance analysis, reconciliations, cash reporting, and executive financial narratives.
