...
import PanelRenderer, { WebviewMode } from './PanelRenderer';
import { CONTROL_PANEL_TITLE } from './PanelStrings';
...
export type PanelHostCallbacks = {
...
export default class PanelHost implements vscode.WebviewViewProvider {
	private readonly _extensionPath: string;
	private readonly _panelRenderer: PanelRenderer;
	private readonly _callbacks: PanelHostCallbacks;
	private _panel: vscode.WebviewPanel | undefined;
	private _sidebarView: vscode.WebviewView | undefined;

	constructor(extensionPath: string, callbacks: PanelHostCallbacks) {
		this._extensionPath = extensionPath;
		this._panelRenderer = new PanelRenderer(extensionPath);
	...
	private _configureWebview(webview: vscode.Webview, mode: WebviewMode): void {
		...
		webview.html = this._panelRenderer.render(webview, mode);
