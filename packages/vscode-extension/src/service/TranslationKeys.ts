...
export const COMPARE_FILE = {
	COMPARE_FILE_WITH_ACCOUNT_FILE: 'COMPARE_FILE_COMPARE_FILE_WITH_ACCOUNT_FILE',
	COMPARING_FILE: 'COMPARE_FILE_COMPARING_FILE',
	ERROR: {
		COMPARE_FILE_TO_SUITEAPP_NOT_ALLOWED: 'COMPARE_FILE_ERROR_COMPARE_FILE_TO_SUITEAPP_NOT_ALLOWED',
		NOT_ALLOWED_FOLDER: 'COMPARE_FILE_ERROR_NOT_ALLOWED_FOLDER',
	},
};
