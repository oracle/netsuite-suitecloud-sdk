...
export const CREATE_FILE = {
	QUESTIONS: {
		CHOOSE_SUITESCRIPT_TYPE: 'CREATE_FILE_CHOOSE_SUITESCRIPT_TYPE',
		ADD_SUITESCRIPT_MODULES: 'CREATE_FILE_ADD_SUITESCRIPT_MODULES',
		ENTER_NAME: 'CREATE_FILE_ENTER_NAME',
		SELECT_FOLDER: 'CREATE_FILE_SELECT_FOLDER',
		SELECT_SUITESCRIPT_MODULES: 'CREATE_FILE_SELECT_SUITESCRIPT_MODULES',
	},
	MESSAGES: {
		CREATING_FILE: 'CREATE_FILE_CREATING_FILE',
		SUITESCRIPT_FILE_CREATED: 'CREATE_FILE_MESSAGE_SUITESCRIPT_FILE_CREATED',
		SUITESCRIPT_FILE_CREATED_WITH_MODULES: 'CREATE_FILE_MESSAGE_SUITESCRIPT_FILE_CREATED_WITH_MODULES',
	},
}
