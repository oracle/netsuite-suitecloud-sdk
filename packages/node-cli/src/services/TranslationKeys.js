...
module.exports = {
	...
	COMMAND_MANAGE_ACCOUNT: {
		...
		QUESTIONS: {
			CONTINUE: 'COMMAND_MANAGE_ACCOUNT_QUESTIONS_CONTINUE',
			MODIFY_TAG: 'COMMAND_MANAGE_ACCOUNT_QUESTIONS_MODIFY_TAG',
			NEW_TAG: 'COMMAND_MANAGE_ACCOUNT_QUESTIONS_NEW_TAG',
		...
		QUESTIONS_CHOICES: {
			ACTIONS: {
				NOTHING: 'COMMAND_MANAGE_ACCOUNT_QUESTIONS_CHOICES_ACTIONS_NOTHING',
		...
		MESSAGES: {
			...
			UPDATING_CREDENTIALS: 'COMMAND_MANAGE_ACCOUNT_MESSAGES_UPDATING_CREDENTIALS',
		},
		OUTPUT: {
