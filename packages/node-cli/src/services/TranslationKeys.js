...
module.exports = {
	...
	COMMAND_COMPAREFILE: {
		ERRORS: {
			PATH_REQUIRED: 'COMMAND_COMPAREFILE_ERRORS_PATH_REQUIRED',
			NO_FOLDERS_FOUND: 'COMMAND_COMPAREFILE_ERRORS_NO_FOLDERS_FOUND',
		},
		MESSAGES: {
			COMPARING_FILE: 'COMMAND_COMPAREFILE_MESSAGES_COMPARING_FILE',
		},
		OUTPUT: {
			DIFF_HEADER: 'COMMAND_COMPAREFILE_OUTPUT_DIFF_HEADER',
			IDENTICAL: 'COMMAND_COMPAREFILE_OUTPUT_IDENTICAL',
			LOCAL_NOT_FOUND: 'COMMAND_COMPAREFILE_OUTPUT_LOCAL_NOT_FOUND',
			NOT_IN_ACCOUNT: 'COMMAND_COMPAREFILE_OUTPUT_NOT_IN_ACCOUNT',
		},
		QUESTIONS: {
			SELECT_FOLDER: 'COMMAND_COMPAREFILE_QUESTIONS_SELECT_FOLDER',
			SELECT_FILE: 'COMMAND_COMPAREFILE_QUESTIONS_SELECT_FILE',
		},
	},
	COMMAND_CREATEFILE: {
		QUESTIONS: {
