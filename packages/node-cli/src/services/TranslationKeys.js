...
module.exports = {
	...
	COMMAND_COMPAREFILES: {
		ERRORS: {
			IS_SUITEAPP: 'COMMAND_COMPAREFILES_ERRORS_IS_SUITEAPP',
			NO_FOLDERS_FOUND: 'COMMAND_COMPAREFILES_ERRORS_NO_FOLDERS_FOUND',
			NO_LOCAL_FILES: 'COMMAND_COMPAREFILES_ERRORS_NO_LOCAL_FILES',
			FILE_NOT_IN_ACCOUNT: 'COMMAND_COMPAREFILES_ERRORS_FILE_NOT_IN_ACCOUNT',
		},
		MESSAGES: {
			IMPORTING_FILE: 'COMMAND_COMPAREFILES_MESSAGES_IMPORTING_FILE',
			COMPARE_COMPLETE: 'COMMAND_COMPAREFILES_MESSAGES_COMPARE_COMPLETE',
			CHECKING_ACCOUNT: 'COMMAND_COMPAREFILES_MESSAGES_CHECKING_ACCOUNT',
		},
		OUTPUT: {
			COMPARING_FILE: 'COMMAND_COMPAREFILES_OUTPUT_COMPARING_FILE',
			FILES_IDENTICAL: 'COMMAND_COMPAREFILES_OUTPUT_FILES_IDENTICAL',
			DIFFERENCES_FOUND: 'COMMAND_COMPAREFILES_OUTPUT_DIFFERENCES_FOUND',
			DIFF_SUMMARY: 'COMMAND_COMPAREFILES_OUTPUT_DIFF_SUMMARY',
			DIFF_SUMMARY_DETAILED: 'COMMAND_COMPAREFILES_OUTPUT_DIFF_SUMMARY_DETAILED',
			COMPARE_ERROR: 'COMMAND_COMPAREFILES_OUTPUT_COMPARE_ERROR',
			FILE_NOT_FOUND: 'COMMAND_COMPAREFILES_OUTPUT_FILE_NOT_FOUND',
		},
		QUESTIONS: {
			SELECT_FOLDER: 'COMMAND_COMPAREFILES_QUESTIONS_SELECT_FOLDER',
			SELECT_FILE: 'COMMAND_COMPAREFILES_QUESTIONS_SELECT_FILE',
			SELECT_LOCAL_FILE: 'COMMAND_COMPAREFILES_QUESTIONS_SELECT_LOCAL_FILE',
		},
	},
	COMMAND_IMPORTFILES: {
		ERRORS: {
