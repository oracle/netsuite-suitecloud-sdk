...
module.exports = {
	...
	DOWNLOADING_SUITECLOUD_SDK_ERROR_FILE_NOT_AVAILABLE: 'DOWNLOADING_SUITECLOUD_SDK_ERROR_FILE_NOT_AVAILABLE',
	ERRORS: {
	...
	UTILS: {
		...
		APPLY_CONTENT_PROTECTION_ARGUMENT_HANDLER: {
			ERRORS: {
				...
				APPLY_CONTENT_PROTECTION_WITH_APPLY_INSTALLATION_PREFERENCES:
					'UTILS_APPLY_CONTENT_PROTECTION_ARGUMENT_HANDLER_ERRORS_APPLY_CONTENT_PROTECTION_WITH_APPLY_INSTALLATION_PREFERENCES',
			},
			WARNINGS : {
				APPLY_CONTENT_PROTECTION_IS_DEPRECATED: 'UTILS_APPLY_CONTENT_PROTECTION_IS_DEPRECATED'
			},
		},
		APPLY_INSTALLATION_PREFERENCES_ARGUMENT_HANDLER: {
			INSTALLATION_PREFERENCES_ERRORS: {
				APPLY_INSTALLATION_PREFERENCES_IN_ACP: 'UTILS_APPLY_INSTALLATION_PREFERENCES_ARGUMENT_HANDLER_ERRORS_APPLY_INSTALLATION_PREFERENCES_IN_ACP',
				APPLY_INSTALLATION_PREFERENCES_WITHOUT_HIDING_LOCKING_AND_OVERWRITING:
					'UTILS_APPLY_INSTALLATION_PREFERENCES_ARGUMENT_HANDLER_ERRORS_APPLY_INSTALLATION_PREFERENCES_WITHOUT_HIDING_LOCKING_AND_OVERWRITING',
			},
		},
		AUTHENTICATION: {
