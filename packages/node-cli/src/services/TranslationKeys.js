...
module.exports = {
	COMMAND_ANALYZE: { MESSAGES: { ANALYZING: 'COMMAND_ANALYZE_MESSAGES_ANALYZING' } },
	ACCOUNT_CREDENTIALS: {
		ACCOUNT_INFO: {
	...
	COMMAND_CONFIGIMPORT: {
		ERRORS: { IS_SUITEAPP: 'COMMAND_CONFIGIMPORT_ERRORS_IS_SUITEAPP' },
		MESSAGES: { IMPORTING: 'COMMAND_CONFIGIMPORT_MESSAGES_IMPORTING' },
		OUTPUT: {
			IMPORTED: 'COMMAND_CONFIGIMPORT_OUTPUT_IMPORTED',
			NONE_IMPORTED: 'COMMAND_CONFIGIMPORT_OUTPUT_NONE_IMPORTED',
			NOT_IMPORTED: 'COMMAND_CONFIGIMPORT_OUTPUT_NOT_IMPORTED',
		},
	},
	COMMAND_CREATEFILE: {
		QUESTIONS: {
		...
		ERRORS: {
			NO_SELECTABLE_FOLDERS: 'COMMAND_CREATEFILE_ERRORS_NO_SELECTABLE_FOLDERS',
		},
		MESSAGES: {
	...
	COMMAND_DEPLOY: {
		...
		WARNINGS: {
			VALIDATE_OPTION_IGNORED: 'COMMAND_DEPLOY_WARNINGS_VALIDATE_OPTION_IGNORED',
		},
		OUTPUT: {},
		QUESTIONS: {
	...
	COMMAND_MANAGE_ACCOUNT: {
		ERRORS: {
			...
			MISSING_OPTION: 'COMMAND_MANAGE_ACCOUNT_ERROR_MISSING_OPTION',
			ONLY_ONE_OPTION_ALLOWED: 'COMMAND_MANAGE_ACCOUNT_ERROR_ONLY_ONE_OPTION_ALLOWED',
			OPTION_NOT_SPECIFIED: 'COMMAND_MANAGE_ACCOUNT_ERROR_OPTION_NOT_SPECIFIED',
			OPTION_RENAME: 'COMMAND_MANAGE_ACCOUNT_ERROR_OPTION_RENAME',
			OPTION_RENAMETO: 'COMMAND_MANAGE_ACCOUNT_ERROR_OPTION_RENAMETO',
		},
		QUESTIONS: {
		...
		OUTPUT: {
			NO_AUTHENTICATION_IDS: 'COMMAND_MANAGE_ACCOUNT_OUTPUT_NO_AUTHENTICATION_IDS',
	...
	COMMAND_PROXY_GENERATEKEY: {
		ERRORS: {
			UNABLE_TO_GENERATE_KEY: 'COMMAND_PROXY_GENERATEKEY_ERROR_UNABLE_TO_GENERATE_KEY',
		},
		SUCCESS_KEY_GENERATED: 'COMMAND_PROXY_GENERATEKEY_SUCCESS_KEY_GENERATED',
	},

	COMMAND_PROXY_START: {
		QUESTIONS: {
			SELECT_AUTH_ID: 'COMMAND_PROXY_START_QUESTIONS_SELECT_AUTH_ID',
			PORT: 'COMMAND_PROXY_START_QUESTIONS_PORT',
		},
		MESSAGES: {
			CONFIGURE_AGENT_HEADER: 'COMMAND_PROXY_START_MESSAGES_CONFIGURE_AGENT_HEADER',
			GUIDE_API_KEY: 'COMMAND_PROXY_START_MESSAGES_GUIDE_API_KEY',
			GUIDE_API_PROVIDER: 'COMMAND_PROXY_START_MESSAGES_GUIDE_API_PROVIDER',
			GUIDE_BASE_URL: 'COMMAND_PROXY_START_MESSAGES_GUIDE_BASE_URL',
			GUIDE_MODEL_ID: 'COMMAND_PROXY_START_MESSAGES_GUIDE_MODEL_ID',
			RUNNING_WITH_AUTH_ID: 'COMMAND_PROXY_START_MESSAGES_RUNNING_WITH_AUTH_ID',
			STOPPED: 'COMMAND_PROXY_START_MESSAGES_STOPPED',
			STOP_INSTRUCTIONS: 'COMMAND_PROXY_START_MESSAGES_STOP_INSTRUCTIONS',
			STOPPING: 'COMMAND_PROXY_START_MESSAGES_STOPPING',
			STARTED: 'COMMAND_PROXY_START_MESSAGES_STARTED',
		},
		ERRORS: {
			PORT_MUST_BE_NUMBER: 'COMMAND_PROXY_START_ERRORS_PORT_MUST_BE_NUMBER',
			PORT_ALREADY_IN_USE: 'COMMAND_PROXY_START_ERRORS_PORT_ALREADY_IN_USE',
		},
	},
	...
	COMMAND_REFRESH_AUTHORIZATION: {
		...
		ERRORS: {
			CHECK_FAILED_CONTEXT: 'COMMAND_REFRESH_AUTHORIZATION_ERRORS_CHECK_FAILED_CONTEXT',
		}
	},
	...
	COMMAND_VALIDATE: {
		ERRORS: {
			ANALYZE_REQUIRES_SUITEAPP: 'COMMAND_VALIDATE_ERRORS_ANALYZE_REQUIRES_SUITEAPP',
		},
		MESSAGES: {
			VALIDATING: 'COMMAND_VALIDATE_MESSAGES_VALIDATING',
		},
		WARNINGS: {
			SERVER_OPTION_IGNORED: 'COMMAND_VALIDATE_WARNINGS_SERVER_OPTION_IGNORED',
		},
		QUESTIONS: {
	...
	PROJECT_COMMAND: {
		MESSAGES: {
			INSTALLATION_PREFERENCES_SELECTED: 'PROJECT_COMMAND_MESSAGES_INSTALLATION_PREFERENCES_SELECTED',
			INSTALLATION_PREFERENCES_NOT_SELECTED: 'PROJECT_COMMAND_MESSAGES_INSTALLATION_PREFERENCES_NOT_SELECTED',
		},
	},
	PROJECT_COMMAND_LOG: {
		MESSAGES: {
			WRITING: 'PROJECT_COMMAND_LOG_MESSAGES_WRITING',
		},
	},
	ERRORS: {
		...
		CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_PARAMETER: 'ERRORS_CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_PARAMETER',
		CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_VM_OPTIONS_NAME: 'ERRORS_CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_VM_OPTIONS_NAME',
		CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_VM_OPTIONS_VALUE: 'ERRORS_CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_IN_VM_OPTIONS_VALUE',
		CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_GENERIC: 'ERRORS_CLI_SDK_JAVA_UNSUPPORTED_CHARACTERS_GENERIC',
	...
	SDK_DOWNLOAD_SERVICE: {
		...
		CHECKSUM_MISMATCH: 'SDK_DOWNLOAD_SERVICE_CHECKSUM_MISMATCH',
		FILE_NOT_AVAILABLE_ERROR: 'SDK_DOWNLOAD_SERVICE_FILE_NOT_AVAILABLE_ERROR',
		MISSING_CHECKSUM: 'SDK_DOWNLOAD_SERVICE_MISSING_CHECKSUM',
	...
	PROXY_AGENT_SERVICE: {
		INVALID_PROXY_CONFIGURATION: 'PROXY_AGENT_SERVICE_INVALID_PROXY_CONFIGURATION',
		UNSUPPORTED_PROXY_PROTOCOL: 'PROXY_AGENT_SERVICE_UNSUPPORTED_PROXY_PROTOCOL'
	},
	UNIT_TEST: {
	...
	UTILS: {
		...
		AUTHENTICATION: {
			...
			CHECKING_AUTHORIZATION: 'UTILS_AUTHENTICATION_CHECKING_AUTHORIZATION',
		...
		CLIENT_API_KEY_UTILS: {
			ERRORS: {
				INVALID_FILE_CONTENTS: 'UTILS_CLIENT_API_KEY_UTILS_ERRORS_INVALID_FILE_CONTENTS',
				MISSING_API_KEY: 'UTILS_CLIENT_API_KEY_UTILS_ERRORS_MISSING_API_KEY',
				READING_FILE_CONTENTS: 'UTILS_CLIENT_API_KEY_UTILS_ERRORS_READING_FILE_CONTENTS',
				WRITING_FILE_CONTENTS: 'UTILS_CLIENT_API_KEY_UTILS_ERRORS_WRITING_FILE_CONTENTS',
			},
			READING_FILE_CONTENTS: 'UTILS_CLIENT_API_KEY_UTILS_READING_FILE_CONTENTS',
			WRITING_FILE_CONTENTS: 'UTILS_CLIENT_API_KEY_UTILS_WRITING_FILE_CONTENTS',
		},
		ERRORS: {
