...
module.exports = {
	COMMAND_IMPORTCONFIGURATION: {
		ERRORS: { IS_SUITEAPP: 'COMMAND_IMPORTCONFIGURATION_ERRORS_IS_SUITEAPP' },
		MESSAGES: { IMPORTING: 'COMMAND_IMPORTCONFIGURATION_MESSAGES_IMPORTING' },
		OUTPUT: {
			IMPORTED: 'COMMAND_IMPORTCONFIGURATION_OUTPUT_IMPORTED',
			NONE_IMPORTED: 'COMMAND_IMPORTCONFIGURATION_OUTPUT_NONE_IMPORTED',
			NOT_IMPORTED: 'COMMAND_IMPORTCONFIGURATION_OUTPUT_NOT_IMPORTED',
		},
	},
	ACCOUNT_CREDENTIALS: {
		ACCOUNT_INFO: {
