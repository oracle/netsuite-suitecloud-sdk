...
export const ANSWERS_VALIDATION_MESSAGES = {
...
export const COMMAND_ADDDEPENDENCIES = {
	MESSAGES: {
...
export const COMMAND_CREATEPROJECT = {
	QUESTIONS: {
	...
	MESSAGES: {
		...
		NAVIGATE_TO_FOLDER: 'COMMAND_CREATEPROJECT_MESSAGE_NAVIGATE_TO_FOLDER',
...
export const COMMAND_DEPLOY = {
	ERRORS: {
		APPLY_CONTENT_PROTECTION_IN_ACP: 'COMMAND_DEPLOY_ERRORS_APPLY_CONTENT_PROTECTION_IN_ACP',
	...
	MESSAGES: {
		...
		NOT_APPLYING_CONTENT_PROTECTION: 'COMMAND_DEPLOY_MESSAGES_NOT_APPLYING_CONTENT_PROTECTION',
		NOT_ASKING_CONTENT_PROTECTION_REASON: 'COMMAND_DEPLOY_MESSAGES_NOT_ASKING_CONTENT_PROTECTION_REASON',
	},
	OUTPUT: {},
};
export const COMMAND_IMPORTFILES = {
	ERRORS: {
...
export const COMMAND_IMPORTOBJECTS = {
	ERRORS: {
...
export const COMMAND_LISTFILES = {
...
export const COMMAND_LISTOBJECTS = {
...
export const COMMAND_MANAGE_ACCOUNT = {
	ERRORS: {
		...
		UNKNOWN_ACTION: 'COMMAND_MANAGE_ACCOUNT_ERROR_UNKNOWN_ACTION',
	},
	QUESTIONS: {
	...
	QUESTIONS_CHOICES: {
		...
		SELECT_AUTHID: {
			...
			EXISTING_AUTH_ID_DEV_URL: 'COMMAND_SETUPACCOUNT_QUESTIONS_CHOICES_SELECT_AUTHID_EXISTING_AUTH_ID_DEV_URL',
		},
	},
	MESSAGES: {
...
export const COMMAND_PACKAGE = {
	PACKAGING: 'COMMAND_PACKAGE_PACKAGING',
};
export const COMMAND_OPTION_INTERACTIVE_HELP = 'COMMAND_OPTION_INTERACTIVE_HELP';
export const COMMAND_OPTION_IS_MANDATORY = 'COMMAND_OPTION_IS_MANDATORY';
export const COMMAND_OPTIONS_VALIDATION_ERRORS = 'COMMAND_OPTIONS_VALIDATION_ERRORS';
export const COMMAND_OPTIONS_VALIDATION_ERRORS_INTERACTIVE_SUGGESTION = 'COMMAND_OPTIONS_VALIDATION_ERRORS_INTERACTIVE_SUGGESTION';

export const COMMAND_PROXY = {
	ARGS_VALIDATION: {
		SET_CLEAR_BOTH_SPECIFIED: 'COMMAND_PROXY_ARGS_VALIDATION_SET_CLEAR_BOTH_SPECIFIED',
		SET_CLEAR_NEITHER_SPECIFIED: 'COMMAND_PROXY_ARGS_VALIDATION_SET_CLEAR_NEITHER_SPECIFIED',
...
export const COMMAND_SETUPACCOUNT = {
	QUESTIONS: {
...
export const COMMAND_ACCOUNTCI = {
	SAVETOKEN_MANDATORY: 'COMMAND_ACCOUNTCI_SAVETOKEN_MANDATORY',
	OUTPUT: {
		NEW_SAVED_TOKEN: 'COMMAND_ACCOUNTCI_OUTPUT_NEW_SAVED_TOKEN',
	},
};
export const COMMAND_SDK_WRAPPER = {
	MESSAGES: {
		EXECUTING_COMMAND: 'COMMAND_SDK_WRAPPER_EXECUTING_COMMAND',
	},
};
export const COMMAND_UPDATE = {
	ERRORS: {
...
export const COMMAND_UPLOADFILES = {
	ERRORS: {
...
export const COMMAND_VALIDATE = {
	MESSAGES: {
		APPLYING_CONTENT_PROTECTION: 'COMMAND_VALIDATE_MESSAGES_APPLYING_CONTENT_PROTECTION',
		NOT_APPLYING_CONTENT_PROTECTION: 'COMMAND_VALIDATE_MESSAGES_NOT_APPLYING_CONTENT_PROTECTION',
...
export const DOWNLOADING_SUITECLOUD_SDK = 'DOWNLOADING_SUITECLOUD_SDK';
export const DOWNLOADING_SUITECLOUD_SDK_SUCCESS = 'DOWNLOADING_SUITECLOUD_SDK_SUCCESS';
export const DOWNLOADING_SUITECLOUD_SDK_ERROR = 'DOWNLOADING_SUITECLOUD_SDK_ERROR';
export const DOWNLOADING_SUITECLOUD_SDK_ERROR_FILE_NOT_AVAILABLE = 'DOWNLOADING_SUITECLOUD_SDK_ERROR_FILE_NOT_AVAILABLE';
export const ERRORS = {
...
export const UTILS = {
	...
	APPLY_CONTENT_PROTECTION_ARGUMENT_HANDLER: {
		ERRORS: {
			APPLY_CONTENT_PROTECTION_IN_ACP: 'UTILS_APPLY_CONTENT_PROTECTION_ARGUMENT_HANDLER_ERRORS_APPLY_CONTENT_PROTECTION_IN_ACP',
