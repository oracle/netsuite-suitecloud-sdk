...
const ValidateOutputHandler = require('../../../../src/commands/project/validate/ValidateOutputHandler');
...
describe('ValidateOutputHandler', () => {
	it.each([
		...
		const outputHandler = new ValidateOutputHandler({ executionPath: '/tmp/project', log });
