...
module.exports = {
	...
	COMMAND_DEPLOY: {
		ERRORS: {
			...
			WRONG_APPLY_CONTENT_PROTECTION_OPTION: 'COMMAND_DEPLOY_ERRORS_WRONG_APPLY_CONTENT_PROTECTION_OPTION'
		},
		QUESTIONS: {
	...
	COMMAND_SETUPACCOUNT: {
		ERRORS: {
			...
			WRITING_ACCOUNT_JSON: 'COMMAND_SETUPACCOUNT_ERRORS_WRITING_ACCOUNT_JSON'
		},
		QUESTIONS: {
			OVERWRITE_ACCOUNT_DETAILS_FILE: 'COMMAND_SETUPACCOUNT_QUESTIONS_OVERWRITE_ACCOUNT_DETAILS_FILE',
