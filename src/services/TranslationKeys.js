...
module.exports = {
	ANSWERS_VALIDATION_MESSAGES: {
		...
		FIELD_HAS_SPACES: 'ERRORS_FIELD_HAS_SPACES',
		FIELD_NOT_LOWER_CASE: 'ERRORS_FIELD_NOT_LOWER_CASE',
		PROJECT_VERSION_FORMAT: 'ERRORS_PROJECT_VERSION_FORMAT',
		PUBLISHER_ID_FORMAT: 'ERRORS_PUBLISHER_ID_FORMAT',
		SCRIPT_ID_FORMAT: 'ERRORS_SCRIPT_ID_FORMAT',
		FIELD_HAS_XML_FORBIDDEN_CHARACTERS: 'ERRORS_FIELD_HAS_XML_FORBIDDEN_CHARACTERS'
	},
	CLI_TITLE: 'CLI_TITLE',
	...
	COMMAND_SETUP: {
		ERRORS: {
			NOT_PROJECT_FOLDER: 'COMMAND_SETUP_ERRORS_NOT_PROJECT_FOLDER',
		},
		QUESTIONS: {
			OVERWRITE_ACCOUNT_DETAILS_FILE: 'COMMAND_SETUP_QUESTIONS_OVERWRITE_ACCOUNT_DETAILS_FILE',
			USE_PRODUCTION_DOMAIN: 'COMMAND_SETUP_QUESTIONS_USE_PRODUCTION_DOMAIN',
			DOMAIN_URL: 'COMMAND_SETUP_QUESTIONS_DOMAIN_URL',
			EMAIL: 'COMMAND_SETUP_QUESTIONS_EMAIL',
			PASSWORD: 'COMMAND_SETUP_QUESTIONS_PASSWORD',
			COMPANY_ID: 'COMMAND_SETUP_QUESTIONS_COMPANY_ID',
			ROLE: 'COMMAND_SETUP_QUESTIONS_ROLE',
			ISSUE_A_TOKEN: 'COMMAND_SETUP_QUESTIONS_ISSUE_A_TOKEN',
			ISSUE_TOKEN_OPTION: 'COMMAND_SETUP_QUESTIONS_ISSUE_TOKEN_OPTION',
			SAVE_TOKEN_OPTION: 'COMMAND_SETUP_QUESTIONS_SAVE_TOKEN_OPTION',
			SAVE_TOKEN_ID: 'COMMAND_SETUP_QUESTIONS_SAVE_TOKEN_ID',
			SAVE_TOKEN_SECRET: 'COMMAND_SETUP_QUESTIONS_SAVE_TOKEN_SECRET',
		},
		MESSAGES: {
			CANCEL_SETUP: 'COMMAND_SETUP_MESSAGES_CANCEL_SETUP',
		},
		OUTPUT: {
