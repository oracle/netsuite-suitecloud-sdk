...
module.exports = {
	...
	SDF_PROJECT_UTILS: {		
		MESSAGES: {
			APPLYING_CONTENT_PROTECTION: 'SDF_PROJECT_UTILS_MESSAGES_APPLYING_CONTENT_PROTECTION',
			NOT_APPLYING_CONTENT_PROTECTION:
				'SDF_PROJECT_UTILS_MESSAGES_NOT_APPLYING_CONTENT_PROTECTION',
		},
	},
	VALIDATE_SDF_PROJECT_UTILS: {
		ERRORS: {
			APPLY_CONTENT_PROTECTION_IN_ACP:
				'VALIDATE_SDF_PROJECT_UTILS_ERRORS_APPLY_CONTENT_PROTECTION_IN_ACP',
			WRONG_ACCOUNT_SPECIFIC_VALUES_OPTION:
				'VALIDATE_SDF_PROJECT_UTILS_ERRORS_WRONG_ACCOUNT_SPECIFIC_VALUES_OPTION',
		},
	},
	YES: 'YES',
};
