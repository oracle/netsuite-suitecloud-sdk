...
module.exports = {
	CLI_TITLE: 'CLI_TITLE',
	COMMAND_IMPORTFILES: {
		ERROR: 'COMMAND_IMPORTFILES_ERROR',
		IMPORTING_FILES: 'COMMAND_IMPORTFILES_IMPORTING_FILES', 
		LOADING_FILES: 'COMMAND_IMPORTFILES_LOADING_FILES',
		LOADING_FOLDERS: 'COMMAND_IMPORTFILES_LOADING_FOLDERS',
		RESTRICTED_FOLDER: 'COMMAND_IMPORTFILES_RESTRICTED_FOLDER',
		SELECT_FOLDER: 'COMMAND_IMPORTFILES_SELECT_FOLDER',
	},
