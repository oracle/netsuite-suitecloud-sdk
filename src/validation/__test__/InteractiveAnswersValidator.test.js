...
describe('validateFieldHasNoSpaces', function() {
    ...
    it('should return false with validation message when string has spaces', function() {
        const expected = {"result": false,"validationMessage": "Error: This field cannot contain spaces."}
...
describe('validateFieldIsLowerCase', function() {
    ...
    it('should return false with validation message when string is not all in lower case', function() {
        const expected = {"result": false,"validationMessage": "Error: This field must be in lower case."}
...
describe('validatePublisherId', function() {
    ...
    it('should return false with validation message when string does not have a \".\"', function() {
        const expected = {"result": false,"validationMessage": "Error: The publisher ID must be a fully qualified name, such as com.netsuite. It must contain lowercase alphanumeric characters and exactly one period. The ID may not begin or end with a period."}
...
describe('validateProjectVersion', function() {
    ...
    it('should return false with validation message when string has letters', function() {
        const expected = {"result": false,"validationMessage": "The project version must only contain digits and dots in the format \"0.0.0\"."}
...
describe('validateArrayIsNotEmpty', function() {
    ...
    it('should return false with validation message when array is empty', function() {
        const expected = {"result": false,"validationMessage": "Error: You should choose at least one option."}
...
describe('validateSuiteApp', function() {
    ...
    it('should return false with validation message when string does not have a \".\"', function() {
        const expected = {"result": false,"validationMessage": "The specified application ID is wrongly formatted. Ensure it follows a pattern such as 'com.example.mysuiteapp'."}
...
describe('validateScriptId', function() {
    ...
    it('should return false with validation message when string is not all in lower case', function() {
        const expected = {"result": false,"validationMessage": "The specified script ID contains forbidden characters. Use only lowercase letters, numbers, or underscores."}
